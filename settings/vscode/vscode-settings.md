...
@ [vscode-user-settings.json](files/vscode-user-settings.json)
```
{
    "files.exclude": {
        "**/node_modules": true
...
@ [vscode-workspace-settings.json](files/vscode-workspace-settings.json)
```
{
	"folders": [
		{
...
@ [vscode-keybindings.json](files/vscode-keybindings.json)
```
[
